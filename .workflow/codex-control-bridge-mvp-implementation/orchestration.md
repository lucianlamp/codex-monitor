# Orchestration: codex-control-bridge MVP implementation
...
P1: Implement Task 1 from `docs/superpowers/plans/2026-06-20-codex-control-bridge-mvp.md`. Own scaffold files only. Use TDD naming contract. Verify with `cargo test --test cli_contract` and `cargo fmt --check`.
